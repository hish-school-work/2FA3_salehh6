...
Let $M = (Q,\Sigma,\Gamma,\delta,s,\bot,F)$ be the NPDA where:
...
\bi
  ...
  \be
    ...
    \item $((s,\epsilon,a),\ (f,\bot))$.

  \ee
	
\ei

$M$ clearly accepts $\set{a^mb^n \mid m,n \ge 1 \mbox{ with } m \not= n}$. by final state.
...
Let $M = (Q,\Sigma,\Gamma,\delta,q,S,\emptyset)$ be the NPDA where:
...
$M$ clearly accepts $L(G)$. by empty stack.
