...
\begin{align*}
  ...
  &= \frac{n+1}{n+1}* \frac{(n+1)*\mname{fact}(n)}{n + 2}  & \pnote{Arithmetic; Fact $\frac{n+1}{n+1} = 1$}\\
  &= \frac{(n+1)*\mname{fact}(n)}{n + 2}  & \pnote{Identity of *}\\
  &= \frac{(n+1)*\mname{fact}(n+1-1)}{(n+1)+1}  & \pnote{Arithmetic}\\
