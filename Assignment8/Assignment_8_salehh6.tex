...
$\langle predicate \rangle$ ::= $ p(\langle a \rangle) ~|~ q(\langle b \rangle, \langle b \rangle)$ \\
$\langle negation \rangle$ ::= $\lnot \langle formula \rangle$ \\ 
$\langle implication \rangle$ ::= $\langle formula \rangle \implies \langle formula \rangle$ \\
$\langle forall \rangle$ ::= $\forall~\langle var \rangle~.~\langle formula \rangle$ \\ 
$\langle term \rangle$ ::= $\langle function \rangle~|~\langle const \rangle~|~\langle var \rangle$ \\
$\langle function \rangle$ ::=  $f(\langle a \rangle, \langle b \rangle ) ~|~ g(\langle b \rangle) $\\
$\langle const \rangle$ ::= $\langle a \rangle~|~\langle b \rangle$ \\
$\langle a \rangle$ ::= $a$ \\
$\langle b \rangle$ ::= $b$ \\
