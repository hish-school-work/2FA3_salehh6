...
\item If A is a subfunction of all the functions of a subset of $(F,\subfun)$, then A is a minimal element of $(F,\subfun)$.

\item If all the functions of a subset of $(F,\subfun)$ are subfunctions of A, then A is a maximal element of $(F,\subfun)$.

\item Yes, the minimum element of $(F,\subfun)$ is a function that is partial and subfunction of all the functions in $(F,\subfun)$.
