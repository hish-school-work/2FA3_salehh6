...
$S \rightarrow ab \mid ba \mid aEb \mid bEa \mid aSa \mid bSb$ \\
$E \rightarrow aE \mid bE \mid a \mid b$ 

  \textcolor{red}{\textbf{Chomsky Normal Form:}} \\
Let $G = (\set{S,A,B,C,D,E,F,G},\set{a,b}, P, S)$ be a grammar in CNF form where $P$ contains the following productions: \\
$S \rightarrow AB \mid BA \mid AC \mid BD \mid AF \mid BG$ \\
$C \rightarrow CB$ \\
$D \rightarrow DA$ \\
$F \rightarrow SA$ \\
$G \rightarrow SB$ \\
...
Let $G = (\set{S,A,B,E},\set{a,b}, P, S)$ be a grammar in GNF form where $P$ contains the following productions: \\
$S \rightarrow aB \mid bA \mid aEB \mid bEA \mid aSA \mid bSB$ \\
$E \rightarrow aE \mid bE \mid a \mid b$ \\
$A \rightarrow a$ \\
$B \rightarrow b$ \\
